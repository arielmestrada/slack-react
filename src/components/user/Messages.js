...
export default function Messages({
  ...
  function sendMessage(headersObject, receiverId, message) {
    ...
    fetch("https://206.189.91.54//api/v1/messages", requestOptions)
  ...
  function retrieveMessage(headersObject, senderId) {
    ...
    fetch(
      `https://206.189.91.54//api/v1/messages?sender_id=${headersObject.currentUserId}&receiver_class=${receiverClass}&receiver_id=${senderId}`,
      requestOptions
    )
      .then((response) => response.text())
  ...
  function getListOfUser(headersObject) {
    ...
    fetch("https://206.189.91.54//api/v1/users", requestOptions)
      .then((response) => response.text())
      .then((result) => {
